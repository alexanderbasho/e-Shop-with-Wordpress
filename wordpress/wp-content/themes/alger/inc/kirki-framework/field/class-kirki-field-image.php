	...
	protected function set_button_labels() {
		...
		$this->button_labels = wp_parse_args( $this->button_labels,
			...
			array(
				...
				'select'       => esc_attr__( 'Select image', 'alger' ),

				'change'       => esc_attr__( 'Change image', 'alger' ),

				'default'      => esc_attr__( 'Default', 'alger' ),

				'remove'       => esc_attr__( 'Remove', 'alger' ),

				'placeholder'  => esc_attr__( 'No image selected', 'alger' ),

				'frame_title'  => esc_attr__( 'Select image', 'alger' ),

				'frame_button' => esc_attr__( 'Choose image', 'alger' ),
