...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		...
		return array(
			...
			'100'       => esc_attr__( 'Ultra-Light 100', 'alger' ),

			'100light'  => esc_attr__( 'Ultra-Light 100', 'alger' ),

			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'alger' ),

			'200'       => esc_attr__( 'Light 200', 'alger' ),

			'200italic' => esc_attr__( 'Light 200 Italic', 'alger' ),

			'300'       => esc_attr__( 'Book 300', 'alger' ),

			'300italic' => esc_attr__( 'Book 300 Italic', 'alger' ),

			'400'       => esc_attr__( 'Normal 400', 'alger' ),

			'regular'   => esc_attr__( 'Normal 400', 'alger' ),

			'italic'    => esc_attr__( 'Normal 400 Italic', 'alger' ),

			'500'       => esc_attr__( 'Medium 500', 'alger' ),

			'500italic' => esc_attr__( 'Medium 500 Italic', 'alger' ),

			'600'       => esc_attr__( 'Semi-Bold 600', 'alger' ),

			'600bold'   => esc_attr__( 'Semi-Bold 600', 'alger' ),

			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'alger' ),

			'700'       => esc_attr__( 'Bold 700', 'alger' ),

			'700italic' => esc_attr__( 'Bold 700 Italic', 'alger' ),

			'800'       => esc_attr__( 'Extra-Bold 800', 'alger' ),

			'800bold'   => esc_attr__( 'Extra-Bold 800', 'alger' ),

			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'alger' ),

			'900'       => esc_attr__( 'Ultra-Bold 900', 'alger' ),

			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'alger' ),

			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'alger' ),
