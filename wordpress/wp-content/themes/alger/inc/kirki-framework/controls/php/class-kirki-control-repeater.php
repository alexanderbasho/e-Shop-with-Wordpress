...
class Kirki_Control_Repeater extends Kirki_Control_Base {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		if ( empty( $this->button_label ) ) {
			...
			$this->button_label = sprintf( esc_attr__( 'Add new %s', 'alger' ), $this->row_label['value'] );
					...
					case 'dropdown-pages':
						...
						$dropdown = wp_dropdown_pages(
							...
							array(
								...
								'show_option_none'  => esc_attr__( 'Select a Page', 'alger' ),
	...
	protected function render_content() {
		...
		<?php if ( isset( $this->choices['limit'] ) ) : ?>
			...
			<p class="limit"><?php printf( esc_attr__( 'Limit: %s rows', 'alger' ), esc_html( $this->choices['limit'] ) ); ?></p>
		...
		<script type="text/html" class="customize-control-repeater-content">
			...
			<li class="repeater-row minimized" data-row="{{{ index }}}">
				...
				<div class="repeater-row-content">
					...
					<# _.each( data, function( field, i ) { #>
						...
						<div class="repeater-field repeater-field-{{{ field.type }}} repeater-field-{{ field.id }}">
							...
							<# } else if ( 'color' === field.type ) { #>
								...
								<input class="color-picker-hex" type="text" maxlength="7" placeholder="<?php esc_attr_e( 'Hex Value', 'alger' ); ?>"  value="{{{ field.default }}}" data-field="{{{ field.id }}}" {{ defaultValue }} />
							...
							<# } else if ( field.type === 'image' || field.type === 'cropped_image' ) { #>
								...
								<figure class="kirki-image-attachment" data-placeholder="<?php esc_attr_e( 'No Image Selected', 'alger' ); ?>" >
									...
									<# } else { #>
										...
										<?php esc_attr_e( 'No Image Selected', 'alger' ); ?>
								...
								<div class="actions">
									...
									<button type="button" class="button remove-button<# if ( ! field.default ) { #> hidden<# } #>"><?php esc_attr_e( 'Remove', 'alger' ); ?></button>

									<button type="button" class="button upload-button" data-label=" <?php esc_attr_e( 'Add Image', 'alger' ); ?>" data-alt-label="<?php echo esc_attr_e( 'Change Image', 'alger' ); ?>" >

										<# if ( field.default ) { #>

											<?php esc_attr_e( 'Change Image', 'alger' ); ?>

										<# } else { #>

											<?php esc_attr_e( 'Add Image', 'alger' ); ?>
							...
							<# } else if ( field.type === 'upload' ) { #>
								...
								<figure class="kirki-file-attachment" data-placeholder="<?php esc_attr_e( 'No File Selected', 'alger' ); ?>" >
									...
									<# } else { #>
										...
										<?php esc_attr_e( 'No File Selected', 'alger' ); ?>
								...
								<div class="actions">
									...
									<button type="button" class="button upload-button" data-label="<?php esc_attr_e( 'Add File', 'alger' ); ?>" data-alt-label="<?php esc_attr_e( 'Change File', 'alger' ); ?>">

										<# if ( field.default ) { #>

											<?php esc_attr_e( 'Change File', 'alger' ); ?>

										<# } else { #>

											<?php esc_attr_e( 'Add File', 'alger' ); ?>
					...
					<button type="button" class="button-link repeater-row-remove"><?php esc_attr_e( 'Remove', 'alger' ); ?></button>
