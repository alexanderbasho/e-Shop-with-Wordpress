...
class Kirki_Control_Image extends Kirki_Control_Base {
	...
	protected function content_template() {
		...
		data.choices.labels = _.defaults( data.choices.labels, {
			...
			select: '<?php esc_attr_e( 'Select image', 'alger' ); ?>',

			change: '<?php esc_attr_e( 'Change image', 'alger' ); ?>',

			'default': '<?php esc_attr_e( 'Default', 'alger' ); ?>',

			remove: '<?php esc_attr_e( 'Remove', 'alger' ); ?>',

			placeholder: '<?php esc_attr_e( 'No image selected', 'alger' ); ?>',

			frame_title: '<?php esc_attr_e( 'Select image', 'alger' ); ?>',

			frame_button: '<?php esc_attr_e( 'Choose image', 'alger' ); ?>',
