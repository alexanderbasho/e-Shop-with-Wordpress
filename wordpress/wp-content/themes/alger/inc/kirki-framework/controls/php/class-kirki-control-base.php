	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_attr__( 'No File Selected', 'alger' ),

				'remove'               => esc_attr__( 'Remove', 'alger' ),

				'default'              => esc_attr__( 'Default', 'alger' ),

				'selectFile'           => esc_attr__( 'Select File', 'alger' ),

				'standardFonts'        => esc_attr__( 'Standard Fonts', 'alger' ),

				'googleFonts'          => esc_attr__( 'Google Fonts', 'alger' ),

				'defaultCSSValues'     => esc_attr__( 'CSS Defaults', 'alger' ),

				'defaultBrowserFamily' => esc_attr__( 'Default Browser Font-Family', 'alger' ),
