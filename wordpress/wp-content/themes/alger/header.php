...
<body <?php body_class( 'page blog' ); ?>>
  <div class="wrapper">
		...
		$header_style = esc_attr(alger_option('header_style'));

		if($header_style == '' || $header_style=='inline' )
			$header_style = 'inline';
			
		$hide_header = apply_filters('alger_hide_header',0);
		...
		$sticky_header = apply_filters('alger_sticky_header',absint($sticky_header));
