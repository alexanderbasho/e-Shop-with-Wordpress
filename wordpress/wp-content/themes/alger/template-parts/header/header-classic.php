<?php
	...
	$logo_position = esc_attr(alger_option('classic_header_logo_position','left'));
	$menu_position = esc_attr(alger_option('classic_header_menu_position','left'));
    ...
    <div class="lq-logo">
      ...
      <div class="lq-microwidgets">
        <div class="lq-microwidget lq-microwidget-banner">
          <?php 
				$classic_header_promo = alger_option('classic_header_promo');
