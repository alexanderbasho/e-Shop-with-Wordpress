<?php
	...
	$footer_icons = alger_option('footer_icons');
	$display_footer_icons = alger_option('display_footer_icons');
	$copyright = alger_option('copyright');
	$footer_fullwidth = alger_option('footer_fullwidth');
	$footer_layout = alger_option('footer_bottom_layout');
	$footer_style = alger_option('footer_bottom_style');
	$footer_menu = alger_option('footer_menu');
	...
	$wrap .= ' '.alger_get_footer_border_style($footer_style);
?>
...
<?php do_action( 'lqthemes_before_footer_bottom' );?>
	...
	if (  $display_footer_icons == '1' || is_customize_preview()):
		$css_class = 'footer-sns alger-footer-sns footer_icons_selective';
		if( $display_footer_icons !=1 && is_customize_preview() )
			$css_class  .= ' hide';
